...
import com.example.myshop.adapter.GucciAdapter;
...
public class GucciActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catID = getIntent().getIntExtra("catID", 6);
        Anhxa();
        ActionToolbar();
        getData(page);
        addEventLoad();
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterGuc.notifyItemInserted(sanPhamMoiList.size()-1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterGuc.notifyItemRemoved(sanPhamMoiList.size());
                page = page+1;
                getData(page);
                adapterGuc.notifyDataSetChanged();
                isLoading = false;
            }
        }, 2000);
    }
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterGuc == null){
                                    ...
                                    adapterGuc = new GucciAdapter(getApplicationContext(), sanPhamMoiList);
                                    recyclerView.setAdapter(adapterGuc);
                                } else {
                                    ...
                                    adapterGuc.notifyItemRangeInserted(vitri, soluongadd);
                                }
                            } else {
    ...
    private void Anhxa() {
        ...
        recyclerView = findViewById(R.id.recycleview_guc);
