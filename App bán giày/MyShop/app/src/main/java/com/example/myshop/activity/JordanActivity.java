...
import com.example.myshop.adapter.JordanAdapter;
...
public class JordanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catID = getIntent().getIntExtra("catID", 3);
        Anhxa();
        ActionToolbar();
        getData(page);
        addEventLoad();
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterJor.notifyItemInserted(sanPhamMoiList.size()-1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterJor.notifyItemRemoved(sanPhamMoiList.size());
                page = page+1;
                getData(page);
                adapterJor.notifyDataSetChanged();
                isLoading = false;
            }
        }, 2000);
    }
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterJor == null){
                                    ...
                                    adapterJor = new JordanAdapter(getApplicationContext(), sanPhamMoiList);
                                    recyclerView.setAdapter(adapterJor);
                                } else {
                                    ...
                                    adapterJor.notifyItemRangeInserted(vitri, soluongadd);
                                }
                            } else {
    ...
    private void Anhxa() {
        ...
        recyclerView = findViewById(R.id.recycleview_jor);
